...
# ============================================================
# LIMPIEZA DE COLUMNAS DERIVADAS PREEXISTENTES
# ============================================================
#
# El archivo de reclasificación 686 ya puede contener columnas
# calculadas previamente desde DatosAlumnos. Para evitar
# colisiones _x/_y, se retiran solamente de la copia en memoria
# y luego se recalculan desde la fuente vigente.

columnas_datosalumnos_recalculables = [
    "DOCUMENTO_NORM_DIAG",
    ...
    "MOTIVO_PENDIENTE",
    "ANIO_CURRICULAR_CANDIDATO",
]

columnas_encontradas = [
    columna
    for columna in columnas_datosalumnos_recalculables
    if columna in casos_124.columns
]

if columnas_encontradas:
    casos_124 = casos_124.drop(
        columns=columnas_encontradas
    )

print(
    "Columnas derivadas de DatosAlumnos retiradas "
    "de la copia de trabajo: "
    f"{len(columnas_encontradas)}"
)
