# CNED BLOQUE 3 - 5 columnas completadas

Fecha de ejecución: 2026-06-04T14:55:25

## Archivos

- Archivo base: `/Users/alexi/Desktop/CNED_BLOQUE_2_5_COLUMNAS_COMPLETADAS.xlsx`
...
- Excel generado en resultados: `/Users/alexi/Documents/GitHub/avance_curricular/indices_2025/cned/resultados/CNED_BLOQUE_3_5_COLUMNAS_COMPLETADAS_20260604_145519.xlsx`
- Excel generado en Escritorio: `/Users/alexi/Desktop/CNED_BLOQUE_3_5_COLUMNAS_COMPLETADAS.xlsx`

## Columnas trabajadas

1. Carrera Genérica
2. Título que otorga el programa
3. Grado Académico que otorga el programa
4. Dependencia
5. Régimen

## Criterio aplicado

- Carrera Genérica: no se infiere desde nombre; queda `REVISAR_CARRERA_GENERICA_SIN_FUENTE_DIRECTA` si no existe fuente documental directa.
- Título que otorga el programa: se mantiene o completa desde `NOMBRE_TITULO` cuando el match no es ambiguo; se conserva literal el valor fuente.
- Grado Académico: no se confunde con título; queda revisión específica porque no hay fuente directa ni confirmación de valor de formulario.
- Dependencia: no se infiere por sede, área ni carrera; queda revisión específica sin fuente directa.
- Régimen: se detecta código `REGIMEN`, pero queda revisión específica por código porque no existe tabla confirmada de conversión al texto del formulario.
...
|:---------------------------------------|:------------------|--------:|
| Carrera Genérica                       | DEJAR_REVISAR     |      71 |
| Dependencia                            | DEJAR_REVISAR     |      71 |
| Grado Académico que otorga el programa | DEJAR_REVISAR     |      71 |
| Régimen                                | DEJAR_REVISAR     |      71 |
| Título que otorga el programa          | DEJAR_REVISAR     |      10 |
| Título que otorga el programa          | MANTENER          |      61 |
...
## Códigos que siguen con revisión en alguna columna del bloque 3
...
|:--------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------|:-----------------------------------------------------------------|:-----------------------------------------------------------------|:----------|
| excel_base_bloque_2       | /Users/alexi/Desktop/CNED_BLOQUE_2_5_COLUMNAS_COMPLETADAS.xlsx                                                                                                   | 33538af76f346ef8c3264c548f6ad55166a340f174382329cace3deaf5735ebf | 33538af76f346ef8c3264c548f6ad55166a340f174382329cace3deaf5735ebf | True      |
...
|:---------|-------:|:-------------------|:----------------|:-----------|-----------------:|:---------|:--------------------|:-------------|:----------|:-----------|:---------------------|:-----------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| True     | 814848 | True               | True            | False      |                0 | False    | False               | False        | False     | False      | False                | False            | ['RESUMEN_EJECUTIVO', 'PROGRAMAS_FALTANTES_PARA_CREAR', 'NO_CREAR_CUBIERTO', 'REQUIERE_DECISION_INSTITUCIONAL', 'DUDOSOS_REV_MANUAL_RESUELTOS', 'DUDOSOS_REV_MANUAL_ACTUALIZADO', 'DICCIONARIO_OFERTA_2026', 'MATCH_PROGRAMAS_VS_DICCIONARIO', 'AUDITORIA_COMPLETITUD', 'AUDITORIA_79_REGISTROS', 'CONTROL_TECNICO', 'AUDITORIA_APLICACION', 'CAMBIOS_APLICADOS', 'CELDAS_REVISAR', 'CONFLICTOS_REVISAR', 'CONTROL_TECNICO_APLICACION', 'AUDITORIA_5_COLUMNAS_BLOQUE_1', 'AUDITORIA_BLOQUE_2', 'AUDITORIA_BLOQUE_3'] |
...
DICTAMEN_FINAL: BLOQUE_3_5_COLUMNAS_COMPLETADO_CON_REVISION_JUSTIFICADA
