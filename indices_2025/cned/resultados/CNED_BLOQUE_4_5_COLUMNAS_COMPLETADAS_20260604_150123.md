...
Fecha de ejecución: 2026-06-04T15:01:30
...
- Excel generado en resultados: `/Users/alexi/Documents/GitHub/avance_curricular/indices_2025/cned/resultados/CNED_BLOQUE_4_5_COLUMNAS_COMPLETADAS_20260604_150123.xlsx`
- Excel generado en Escritorio: `/Users/alexi/Desktop/CNED_BLOQUE_4_5_COLUMNAS_COMPLETADAS.xlsx`

## Columnas trabajadas

1. Duración del programa en Semestres
2. Ingreso Directo
3. Ingreso desde un plan Común
4. Ingreso desde Bachillerato
5. Otro Tipo de Ingreso

## Criterio aplicado

- Duración: se mantienen valores numéricos existentes; el único caso ambiguo queda como `CONFLICTO_REVISAR_DURACION_MATCH_AMBIGUO`.
- Ingreso Directo: no se marca por defecto; queda revisión específica trazada por `REQUISITO_INGRESO`/`SEMESTRES_RECONOCIDOS` cuando existen, o por match ambiguo.
- Ingreso desde plan común: se marca `NO_APLICA_SIN_EVIDENCIA_PLAN_COMUN` al no existir fuente directa ni evidencia específica.
- Ingreso desde bachillerato: se marca `NO_APLICA_SIN_EVIDENCIA_BACHILLERATO` al no existir fuente directa ni evidencia específica.
- Otro Tipo de Ingreso: se marca no aplica solo cuando no hay señal de requisito alternativo; si existe `REQUISITO_INGRESO` distinto de 1 o semestres reconocidos, queda revisión específica.
...
## Códigos que siguen con revisión o conflicto en alguna columna del bloque 4
