...
- total_columnas: 48
- issues_total: 178
- por_severidad: {'BLOQUEANTE': 158, 'REVISION': 20}
- por_regla: {'OA1-008': 6, 'OA1-011': 92, 'OA1-012': 38, 'OA1-018': 22, 'OA1-020': 2, 'OA1-021': 18}
- por_campo: {'ANIO_INICIO': 22, 'ENLACE_INFO_PROGRAMA': 46, 'FECHA_ADMISION_INICIAL': 46, 'MALLA_CURRICULAR': 1, 'PERFIL_EGRESO': 1, 'VACANTES_PRIMER_SEMESTRE': 2, 'VACANTES_PRIMER_SEMESTRE,VACANTES_SEGUNDO_SEMESTRE,VIGENCIA_CARRERA': 8, 'VACANTES_PRIMER_SEMESTRE,VIGENCIA_CARRERA': 10, 'VACANTES_SEGUNDO_SEMESTRE': 36, 'areas_destino': 6}
...
| OA1-011 | BLOQUEANTE | 4 | INGENIERIA EN FINANZAS | ENLACE_INFO_PROGRAMA | Campo obligatorio cuando VIGENCIA_CARRERA=1. |
...
| OA1-011 | BLOQUEANTE | 5 | INGENIERIA EN MARKETING DIGITAL | ENLACE_INFO_PROGRAMA | Campo obligatorio cuando VIGENCIA_CARRERA=1. |
...
| OA1-011 | BLOQUEANTE | 6 | INGENIERIA EN RECURSOS HUMANOS | ENLACE_INFO_PROGRAMA | Campo obligatorio cuando VIGENCIA_CARRERA=1. |
...
| OA1-011 | BLOQUEANTE | 9 | INGENIERIA EN PREVENCION DE RIESGOS | ENLACE_INFO_PROGRAMA | Campo obligatorio cuando VIGENCIA_CARRERA=1. |
...
| OA1-011 | BLOQUEANTE | 10 | INGENIERIA EN SEGURIDAD PRIVADA | ENLACE_INFO_PROGRAMA | Campo obligatorio cuando VIGENCIA_CARRERA=1. |
...
| OA1-011 | BLOQUEANTE | 26 | AUDITORIA | ENLACE_INFO_PROGRAMA | Campo obligatorio cuando VIGENCIA_CARRERA=1. |
...
| OA1-011 | BLOQUEANTE | 27 | INGENIERIA INDUSTRIAL | ENLACE_INFO_PROGRAMA | Campo obligatorio cuando VIGENCIA_CARRERA=1. |
...
| OA1-011 | BLOQUEANTE | 28 | INGENIERIA EN CIENCIA DE DATOS | ENLACE_INFO_PROGRAMA | Campo obligatorio cuando VIGENCIA_CARRERA=1. |
...
| OA1-011 | BLOQUEANTE | 30 | TECNICO EN PROGRAMACION Y ANALISIS DE SISTEMAS | ENLACE_INFO_PROGRAMA | Campo obligatorio cuando VIGENCIA_CARRERA=1. |
...
| OA1-011 | BLOQUEANTE | 31 | INGENIERIA EN CIBERSEGURIDAD | ENLACE_INFO_PROGRAMA | Campo obligatorio cuando VIGENCIA_CARRERA=1. |
...
| OA1-011 | BLOQUEANTE | 32 | INGENIERIA EN INFORMATICA | ENLACE_INFO_PROGRAMA | Campo obligatorio cuando VIGENCIA_CARRERA=1. |
...
| OA1-011 | BLOQUEANTE | 33 | INGENIERIA EN CONECTIVIDAD Y REDES | ENLACE_INFO_PROGRAMA | Campo obligatorio cuando VIGENCIA_CARRERA=1. |
...
| OA1-011 | BLOQUEANTE | 34 | INGENIERIA EN ADMINISTRACION DE EMPRESAS | ENLACE_INFO_PROGRAMA | Campo obligatorio cuando VIGENCIA_CARRERA=1. |
...
| OA1-011 | BLOQUEANTE | 36 | TECNICO EN CIBERSEGURIDAD | ENLACE_INFO_PROGRAMA | Campo obligatorio cuando VIGENCIA_CARRERA=1. |
...
| OA1-011 | BLOQUEANTE | 37 | TECNICO EN ENFERMERIA | ENLACE_INFO_PROGRAMA | Campo obligatorio cuando VIGENCIA_CARRERA=1. |
| OA1-011 | BLOQUEANTE | 38 | INGENIERIA EN LOGISTICA | FECHA_ADMISION_INICIAL | Campo obligatorio cuando VIGENCIA_CARRERA=1. |
| OA1-011 | BLOQUEANTE | 38 | INGENIERIA EN LOGISTICA | ENLACE_INFO_PROGRAMA | Campo obligatorio cuando VIGENCIA_CARRERA=1. |
...
| OA1-011 | BLOQUEANTE | 39 | TECNICO EN ENFERMERIA E INSTRUMENTACION QUIRURGICA | ENLACE_INFO_PROGRAMA | Campo obligatorio cuando VIGENCIA_CARRERA=1. |
...
| OA1-011 | BLOQUEANTE | 41 | TECNICO EN LOGISTICA | ENLACE_INFO_PROGRAMA | Campo obligatorio cuando VIGENCIA_CARRERA=1. |
...
| OA1-011 | BLOQUEANTE | 42 | ADMINISTRACION PUBLICA | ENLACE_INFO_PROGRAMA | Campo obligatorio cuando VIGENCIA_CARRERA=1. |
...
| OA1-011 | BLOQUEANTE | 43 | TECNICO EN ADMINISTRACION DE EMPRESAS | ENLACE_INFO_PROGRAMA | Campo obligatorio cuando VIGENCIA_CARRERA=1. |
...
| OA1-011 | BLOQUEANTE | 45 | TECNICO EN ENFERMERIA | ENLACE_INFO_PROGRAMA | Campo obligatorio cuando VIGENCIA_CARRERA=1. |
