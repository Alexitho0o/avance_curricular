...
- Distribucion `SIT_FON_SOL`: {'1': 2587}
- Distribucion `SUS_PRE`: {'0': 2587}
- Distribucion `REINCORPORACION`: {'0': 2587}
- Distribucion `VIG`: {'1': 2308, '2': 279}
...
- Filas `VIG = 2`: 279
- Filas `VIG = 2` por politica de titulado aprobado: 279
