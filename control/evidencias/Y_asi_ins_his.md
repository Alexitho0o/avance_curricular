...
- gobernanza_columnas_mu/gob_mu_asi_ins_his.tsv
...
- La salida actual calcula `ASI_INS_HIS` por llave `RUT_NORM + CODCARPR_NORM` usando `COUNT_DISTINCT_CODRAMO_ALCANCE_HIST_DISPONIBLE`.
...
- `ASI_INS_HIS = ASI_INS_ANT` en `1.736/1.736` filas incluidas.
