...
- `COD_SED` final se obtiene por parseo del componente sede de `CODIGO_CARRERA_SIES_FINAL`.
- La fila incluida conserva trazabilidad en `COD_SED_FUENTE_FINAL`, `COD_SED_METODO_FINAL` y `COD_SED_AUDIT_STATUS`.
...
- Inconsistencias `COD_SED` vs parseo SIES final: `0`.
